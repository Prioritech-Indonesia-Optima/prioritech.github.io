...
export default function ProjectsPage() {
  ...
  const projectCategories = [
    ...
    },
    {
      ...
      description: 'End-to-end business platforms — finance, operations, people, and channel.',
      projects: [
        {
          title: 'ERP Suite',
          description: 'Unified finance, sales, inventory, HR and manufacturing on a single ledger of truth.',
          impact: 'One pane of glass for cross-functional operations.',
          techStack: ['Postgres', 'Event Sourcing', 'GraphQL', 'Next.js'],
          category: 'enterprise',
        },
        {
          title: 'Warehouse Management System',
          description: 'Bay-level inventory, optimized pick paths, and forklift orchestration with live floor maps.',
          impact: '184 picks / hour · 82% fill rate.',
          techStack: ['Realtime DB', 'Path Optimization', 'RF Scanners'],
          category: 'enterprise',
        },
        {
          title: 'Supply Chain Management',
          description: 'End-to-end visibility from supplier to retail with proactive risk scoring.',
          impact: '96% on-time, 18% shorter lead times.',
          techStack: ['EDI', 'Risk Models', 'Event Streaming'],
          category: 'enterprise',
        },
        {
          title: 'Customer Relationship Management',
          description: 'Pipeline visibility, deal flow, and revenue intelligence with embedded analytics.',
          impact: '+34% win rate, −24% sales cycle.',
          techStack: ['ML Scoring', 'Reverse-ETL', 'TypeScript'],
          category: 'enterprise',
        },
        {
          title: 'HRIS / HCM Platform',
          description: 'Headcount, attendance, payroll cycles, retention — workforce intelligence built in.',
          impact: 'Payroll cycles cut from 3 days to 4 hours.',
          techStack: ['Payroll Engine', 'Time Tracking', 'Compliance'],
          category: 'enterprise',
        },
        {
          title: 'Manufacturing Execution System',
          description: 'Live OEE, work-order tracking, and alarm management across production lines.',
          impact: 'OEE +9pp, scrap rate −36%.',
          techStack: ['OPC-UA', 'MQTT', 'TimescaleDB'],
          category: 'enterprise',
        },
        {
          title: 'Transportation Management',
          description: 'Fleet live tracking with route optimization and proof-of-delivery capture.',
          impact: '−18% fuel, 94% on-time.',
          techStack: ['Route Optimization', 'GPS Telemetry', 'Mobile SDK'],
          category: 'enterprise',
        },
        {
          title: 'Point of Sale Platform',
          description: 'Live transactions across terminals, product mix analytics, and end-of-day reconciliation.',
          impact: 'Sub-second checkout · auto reconciliation.',
          techStack: ['Edge Sync', 'Tax Engine', 'EMV / QRIS'],
          category: 'enterprise',
        },
      ],
    },
